...
var getRegisteredSalt = function (email) {
    ...
    return callSaltmine('GET', { email: email })
        .then(function (r) { return r.text(); })
        .then(fromBase64)
        // @ts-ignore
        .then(function (buffer) { return new Uint8Array(buffer).slice(0, 32); });
...
var regenerateReadwriteKeypair = function (email, password, getRegisteredSaltCallback) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var registeredSalt, hash, keypair, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    return [4 /*yield*/, getRegisteredSaltCallback(email)];
                case 1:
                    registeredSalt = _a.sent();
                    if (!registeredSalt) return [3 /*break*/, 4];
                ...
                case 5:
                    e_2 = _a.sent();
                    return [2 /*return*/, console.error('No salt found. Unable to log in.', e_2)];
