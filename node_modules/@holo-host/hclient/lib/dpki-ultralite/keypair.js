...
var Keypair = /** @class */ (function () {
     ...
     */
    Keypair.newFromSeed = function (seed) {
        return new Promise(function (resolve, reject) {
            _sodium.ready.then(function (_) {
                var _a = _sodium.crypto_sign_seed_keypair(seed), signPub = _a.publicKey, signPriv = _a.privateKey;
                var _b = _sodium.crypto_kx_seed_keypair(seed), encPub = _b.publicKey, encPriv = _b.privateKey;
     ...
     * @return {string}
     */
    Keypair.prototype.getId = function () {
    ...
    Keypair.prototype.sign = function (data) {
        ...
        return new Promise(function (resolve, reject) {
            _sodium.ready.then(function (_) {
                resolve(_sodium.crypto_sign_detached(data, _this_1._signPriv));
     ...
     * @param {Buffer} data
     */
    Keypair.prototype.verify = function (signature, data) {
        var _this_1 = this;
        return new Promise(function (resolve, reject) {
            util.verify(signature, data, _this_1._pubkeys).then(function (_) {
                resolve(_);
                reject('failure reason'); // rejected
            });
        });
     ...
     * @return {Buffer}
     */
    Keypair.prototype.encrypt = function (recipientIds, data, adata) {
        var _this = this;
                    ...
                    return new Promise(function (resolve, reject) {
                        var _loop = function _loop(i, p) {
                            util.decodeId(recipientIds[i]).then(function (key) {
                                ...
                                var sodiumCryptoTxSer = _sodium.crypto_kx_server_session_keys(_this._encPub, _this._encPriv, recipPub);
                                var tx = sodiumCryptoTxSer.sharedTx;
     ...
     */
    Keypair.prototype.decrypt = function (sId, cipher, adata) {
        var _this_1 = this;
        ...
        return new Promise(function (resolve, reject) {
            _sodium.ready.then(function (_) {
                util.decodeId(sId).then(function (id) {
                    ...
                    var rx = _sodium.crypto_kx_client_session_keys(_this_1._encPub, _this_1._encPriv, sourceId).sharedRx;
                    var symSecret = null;
     ...
     */
    Keypair.prototype.getBundle = function (passphrase, hint) {
        var _this_1 = this;
        ...
        return new Promise(function (resolve, reject) {
            util.pwEnc(msgpack.encode([
                _this_1._signPub, _this_1._encPub,
                _this_1._signPriv, _this_1._encPriv
            ]), passphrase).then(function (data) {
                resolve({
                    type: 'hcKeypair',
                    hint: hint,
                    data: data
     ...
     */
    Keypair.fromBundle = function (bundle, passphrase) {
        return new Promise(function (resolve, reject) {
            util.pwDec(bundle.data, passphrase).then(function (encodedBundle) {
