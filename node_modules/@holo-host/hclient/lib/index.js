...
var hClient = (function () {
    ...
    var _c = require('./resolver'), getDnaForUrl = _c.getDnaForUrl, getHostsForUrl = _c.getHostsForUrl;
     ...
     * Leave as default unless you know what you are doing.
     */
    var makeWebClient = function (holochainClient, happId, optionals) {
        if (optionals === void 0) { optionals = {}; }
        return __awaiter(_this, void 0, void 0, function () {
            var url, _a, dnaHash, _b, preCall, postCall, postConnect;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getDefaultWebsocketUrl()];
                    case 1:
                        _a = (_c.sent());
                        _c.label = 2;
                    case 2:
                        url = _a;
                        _b = optionals.dnaHash;
                        if (_b) return [3 /*break*/, 4];
                        return [4 /*yield*/, getDnaForUrl(window.location.origin)];
                    case 3:
                        _b = (_c.sent());
                        _c.label = 4;
                    case 4:
                        ...
                        return [2 /*return*/, {
                                connect: function () { return holochainClient.connect(url).then(function (_a) {
                                                                    ...
                                                                    return __generator(this, function (_b) {
                                                                        switch (_b.label) {
                                                                            case 0:
                                                                                ...
                                                                                return [4 /*yield*/, preCall(dnaHash, callString, params)];
                                                                            case 1:
     ...
     */
    var getDefaultWebsocketUrl = function () { return __awaiter(_this, void 0, void 0, function () {
        var hosts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getHostsForUrl(window.location.origin)];
                case 1:
                    hosts = _a.sent();
                    return [2 /*return*/, 'ws://' + hosts[0]];
            }
        });
    }); };
     ...
     */
    var _preCall = function (dnaHash, callString, params) { return __awaiter(_this, void 0, void 0, function () {
