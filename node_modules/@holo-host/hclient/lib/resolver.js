...
var callResolver = function (params) {
 ...
 */
var getHashForUrl = function (DNS) {
    return callResolver({ url: DNS })
        .then(function (r) { return r.json(); })
        .then(function (json) { return json.hash; }); // this is the HHA hAppHash
};
/**
 * Displays the login dialog and generates a new read/write key with the email/password
 * This will overwrite the current key
 * @memberof module:hClient
 */
var getHostsForUrl = function (DNS) {
    return callResolver({ url: DNS })
        .then(function (r) { return r.json(); })
        .then(function (json) { return json.hosts; });
};
module.exports = {
