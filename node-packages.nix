...
let
  sources = {
    ...
    "@holo-host/hclient-git+https://github.com/Holo-Host/hClient.js.git#8e4f02a5c9a7ec13daa1476b4ba37b171493bc6d" = {
      name = "_at_holo-host_slash_hclient";
      packageName = "@holo-host/hclient";
      version = "0.2.8";
      src = fetchgit {
        url = "https://github.com/Holo-Host/hClient.js.git";
        rev = "8e4f02a5c9a7ec13daa1476b4ba37b171493bc6d";
        sha256 = "a2909dfdcf1bf1db03dfc88a2cdcede26d34bf31028cadd1ea0fbda6bda84fea";
      };
    };
    "@holochain/hc-web-client-0.1.3" = {
      name = "_at_holochain_slash_hc-web-client";
      packageName = "@holochain/hc-web-client";
      version = "0.1.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/@holochain/hc-web-client/-/hc-web-client-0.1.3.tgz";
        sha512 = "Ova+nCjcWA0OtxNm2I0V44d1CwggseFK3AIuE3lOIccKID/CG5WPRG9rxYBt2zGNaeRh0LfOdbM5E6F7Cau2mA==";
      };
    };
    ...
    "dialog-polyfill-0.4.10" = {
      ...
      version = "0.4.10";
      src = fetchurl {
        url = "https://registry.npmjs.org/dialog-polyfill/-/dialog-polyfill-0.4.10.tgz";
        sha512 = "j5yGMkP8T00UFgyO+78OxiN5vC5dzRQF3BEio+LhNvDbyfxWBsi3sfPArDm54VloaJwy2hm3erEiDWqHRC8rzw==";
      };
    };
    "diff-3.5.0" = {
      name = "diff";
    ...
    "libsodium-sumo-0.7.4" = {
      ...
      version = "0.7.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/libsodium-sumo/-/libsodium-sumo-0.7.4.tgz";
        sha512 = "xBQaiQ7X0pKmeT7+stva/JplcqdDzd3sag2nVC+UIenYg33w5QUihuZfI1+7JVODvCr4MXFsHm9lv+eIVrJALA==";
      };
    };
    "libsodium-wrappers-sumo-0.7.4" = {
      ...
      version = "0.7.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/libsodium-wrappers-sumo/-/libsodium-wrappers-sumo-0.7.4.tgz";
        sha512 = "znWGEGMXru7uIilryz+FvOTrNfT7yK0+17yOqVqp6nRulB9fjfML3VtFKMShOyWjlPqrFFPgYyeVrFb9I2th3g==";
      };
    };
    "lodash-4.17.11" = {
      name = "lodash";
    ...
    "rpc-websockets-git://github.com/maackle/rpc-websockets#8fafa1be389bc8843d43285490c9ae0fac2fccf4" = {
      name = "rpc-websockets";
    ...
    "sinon-7.2.4" = {
      ...
      version = "7.2.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/sinon/-/sinon-7.2.4.tgz";
        sha512 = "FGlcfrkiBRfaEIKRw8s/9mk4nP4AMGswvKFixLo+AzsOhskjaBCHAHGLMd8pCJpQGS+9ZI71px6qoQUyvADeyA==";
      };
    };
    "source-map-0.6.1" = {
      name = "source-map";
    ...
    "tape-4.10.0" = {
      ...
      version = "4.10.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/tape/-/tape-4.10.0.tgz";
        sha512 = "3PgdF0vcZ1t7HEYbpTXdo58KXi19QCGcZfj07A53M2DH14P2Fw3cB3f9pF7e/Br2z+PQm7xlvhjzHH3D8ti99g==";
      };
    };
    "tape-promise-4.0.0" = {
      name = "tape-promise";
    ...
    "ts-node-8.0.2" = {
      ...
      src = fetchurl {
        ...
        sha512 = "MosTrinKmaAcWgO8tqMjMJB22h+sp3Rd1i4fdoWY4mhBDekOwIAKI/bzmRi7IcbCmjquccYg2gcF6NBkLgr0Tw==";
      };
    };
    "type-detect-0.1.1" = {
      name = "type-detect";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@holo-host/hclient-git+https://github.com/Holo-Host/hClient.js.git#8e4f02a5c9a7ec13daa1476b4ba37b171493bc6d"
      sources."@holochain/hc-web-client-0.1.3"
      ...
      sources."dialog-polyfill-0.4.10"
      sources."diff-3.5.0"
      ...
      sources."libsodium-sumo-0.7.4"
      sources."libsodium-wrappers-sumo-0.7.4"
      ...
      sources."rpc-websockets-git://github.com/maackle/rpc-websockets#8fafa1be389bc8843d43285490c9ae0fac2fccf4"
      ...
      sources."ts-node-8.0.2"
      sources."type-detect-4.0.8"
      sources."type-is-1.6.16"
      sources."typedarray-0.0.6"
      sources."typescript-3.3.3333"
