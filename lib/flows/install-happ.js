...
exports.setupHolofuelBridge = (client, { callerInstanceId, replace }) => __awaiter(this, void 0, void 0, function* () {
    const bridgeConfig = {
        handle: 'holofuel-bridge',
        caller_id: callerInstanceId,
        callee_id: Config.holofuelId.instance,
    };
    const bridges = yield client.call('admin/bridge/list', {});
...
exports.setupInstances = (client, opts) => __awaiter(this, void 0, void 0, function* () {
    ...
    const dnaPromises = dnas.map((dna) => __awaiter(this, void 0, void 0, function* () {
        ...
        const instanceId = common_1.instanceIdFromAgentAndDna({ agentId, dnaHash: dnaId });
...
exports.setupServiceLogger = (masterClient, { hostedHappId }) => __awaiter(this, void 0, void 0, function* () {
    ...
    yield exports.setupHolofuelBridge(masterClient, { callerInstanceId: instanceId, replace: false });
...
exports.lookupAppEntryInHHA = (client, { happId }) => __awaiter(this, void 0, void 0, function* () {
    let appHash;
    try {
        appHash = yield getHappHashFromHHA(client, happId);
    }
    catch (e) {
    ...
    try {
        const happ = yield exports.lookupAppInStoreByHash(client, appHash);
...
exports.lookupAppInStoreByHash = (client, appHash) => {
...
exports.lookupDnaByHandle = (client, happId, handle) => __awaiter(this, void 0, void 0, function* () {
    console.log("looking up happId, handle: ", happId, handle);
    const appHash = yield getHappHashFromHHA(client, happId);
    const app = yield exports.lookupAppInStoreByHash(client, appHash);
...
const downloadResource = (baseDir, res, type) => __awaiter(this, void 0, void 0, function* () {
    ...
    return common_1.downloadFile({ url: res.location, path: resourcePath });
});
